...
namespace LessonHW4
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //Задание: запросить у пользователя кол-во чисел Фибоначчи, 
            //которое он хотел бы сгенерировать(вычислить), и, собственно, произвести генерацию(вычисление). 

            //В процессе генерации записывать числа в массив.После генерации вывести вычисленные числа.


            Console.WriteLine("Введите количество числ Фибоначчи: ");
